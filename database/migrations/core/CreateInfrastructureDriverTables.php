...
final readonly class CreateInfrastructureDriverTables implements Migration
{
    ...
    public function up(MigrationContext $context): void
    {
        $context->execute(new CompiledQuery(
            ...
            . '`key_hash` CHAR(64) NOT NULL, `cache_key` VARCHAR(191) NOT NULL, `cache_value` LONGBLOB NOT NULL, '
        ...
        $context->execute(new CompiledQuery(
            ...
            . '`session_hash` CHAR(64) NOT NULL, `session_id` VARCHAR(191) NOT NULL, `payload` LONGBLOB NOT NULL, '
