...
final readonly class PaymentRefundResult
{
    public function __construct(
        ...
        if(in_array($this->state,[PaymentRefundState::Pending,PaymentRefundState::Succeeded],true)
            &&$this->providerRefundReference===null
        ){
            throw new InvalidArgumentException('Payment refund state requires a provider refund reference.');
        }
