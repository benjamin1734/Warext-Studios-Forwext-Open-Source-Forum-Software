...
final readonly class ContentValidationProcessor implements ContentPipelineProcessor
{
    ...
    public function process(
        ...
        if($text===''||strlen($text)>$context->maxBytes
            ...
            throw new ContentPipelineRejectedException('Content validation rejected the submission.');
        }

        return $text===$context->text?$context:$context->withText($text);
    }
}
