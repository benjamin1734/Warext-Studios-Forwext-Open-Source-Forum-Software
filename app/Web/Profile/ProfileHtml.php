...
final class ProfileHtml
{
    public static function page(
        ...
        return '<!doctype html><html lang="tr"><head><meta charset="utf-8">'
            ...
            . '.search-form input,.search-form select,.search-form textarea,.member-directory-form input,.member-directory-form select,.presence-settings select{width:100%;border:1px solid var(--line);background:#0d1117;color:var(--text);border-radius:9px;padding:10px 11px;font:inherit}.search-form textarea{resize:vertical}'
