...
- Completed sub-steps: `01.01` through `01.06`, `02.01` through `02.07`, `03.01` through `03.07`, `04.01`
- Current sub-step: `04.02`
- Persistent server installation required yet: `available — user-domain persistence is now part of the migration path; registration/auth/profile layers continue from 04.02`
