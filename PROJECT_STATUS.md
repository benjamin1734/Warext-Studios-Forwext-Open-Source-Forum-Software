...
- Completed sub-steps: `01.01` through `01.06`, `02.01` through `02.07`, `03.01` through `03.06`
- Current sub-step: `03.07`
- Persistent server installation required yet: `available — migration engine and concrete infrastructure/runtime migrations exist; full application install expands as later domain schema migrations land`
