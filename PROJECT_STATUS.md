...
- Completed sub-steps: `01.01` through `01.06`, `02.01` through `02.07`, `03.01` through `03.07`
- Current sub-step: `04.01`
- Persistent server installation required yet: `available — migration/install infrastructure and foundational runtime migrations exist; application-domain schema continues from Main Step 04 onward`
